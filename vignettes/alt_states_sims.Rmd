...
perterb_plot <- ad_sims %>%
    ...
    guides(color = guide_legend("Trait:", override.aes = list(size = 2))) +
    ylab("Trait value") +
    xlab("Time")

perterb_plot

# ggsave(perterb_plot, filename = "perterb_p.pdf", width = 6, height = 4)
...
=========================================================================================
        ...
        R version (doesn't work well, but could
