...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double& >::type sigma_N(sigma_NSEXP);
    Rcpp::traits::input_parameter< const std::vector<double>& >::type sigma_V(sigma_VSEXP);
    Rcpp::traits::input_parameter< const bool& >::type phenos(phenosSEXP);
    ...
    Rcpp::traits::input_parameter< const bool& >::type show_progress(show_progressSEXP);
    Rcpp::traits::input_parameter< const uint32_t& >::type n_threads(n_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(quant_gen_cpp(n_reps, V0, Vp0, N0, f, a0, C, r0, D, add_var, sigma_V0, sigma_N, sigma_V, phenos, spp_gap_t, final_t, min_N, save_every, show_progress, n_threads));
    return rcpp_result_gen;
END_RCPP
}
// trunc_rnorm_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sauron_quant_gen_cpp", (DL_FUNC) &_sauron_quant_gen_cpp, 20},
