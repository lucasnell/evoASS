...
plots[[1]]
# ggsave("~/Desktop/landscape1.pdf", plots[[1]], width = 6.5, height = 4.5)
```
...
plots[[2]]
# ggsave("~/Desktop/landscape2.pdf", plots[[2]], width = 6.5, height = 4.5)
```
...
plots[[3]]
# ggsave("~/Desktop/landscape3.pdf", plots[[3]], width = 6.5, height = 4.5)
```
