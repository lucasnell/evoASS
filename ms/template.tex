...
$-- % NOTE: In pandoc, lines started with `$--` are ignored, hence me adding this
...
$-- %Or article, e-article, e-note, natural history miscellany, e-natural history miscellany, comment, reply, invited symposium, or countdown to 150.
...
$-- % For how to compile .bbl file, see https://tex.stackexchange.com/a/351487
